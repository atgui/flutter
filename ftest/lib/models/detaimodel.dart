class VideoDetailModel {
  ...
  VideoDetailModel(
      {this.m3u8, this.videoUrl, this.title, this.actorer, this.genres,this.thumbHigh});
  List<Genre> genres;
  @override
  String toString() {
    // TODO: implement toString
    return "[m3u8=${this.m3u8},videoUrl=${this.videoUrl},title=${this.title},thumbHigh=${this.thumbHigh},actorer=${this.actorer.toString()}]";
  }
}
...
class Genre {
  ...
  static List<Genre> fromJson(List json) {
    ...
    return json
        .map((string) =>
            new Genre(shortId: string['shortId'], name: string['name']))
        .toList();
  }
}
